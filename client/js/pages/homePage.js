    ...
    <div class="row">
        <main class="col-sm-8">
            <div class="drop-zone-title-wrapper">
                ...
                <h6 class="help-subtitle">5000 Character Limit of text analysed per document. If needed print a PDF of a <a href="https://en.wikipedia.org/wiki/Special:Random" target="_blank">random Wikipedia article</a> for testing. <h6>
            </div>
            <div class="drop-zone"> 
